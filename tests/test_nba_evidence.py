...
def test_allowed_bundle_builds_local_and_tinker_cards() -> None:
    ...
    assert numeric_feature_differences(bundle) == (("trailing_net_rating", 4.1),)
    assert numeric_feature_vector(bundle, ("trailing_net_rating",)) == (4.1,)
    ...
    with pytest.raises(NbaEvidenceError, match="predeclared schema"):
        numeric_feature_vector(bundle, ("travel_miles",))
